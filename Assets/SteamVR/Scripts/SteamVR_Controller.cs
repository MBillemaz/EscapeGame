	...
	public class Device
	{
		...
		public void Update()
		{
			if (Time.frameCount != prevFrameCount)
			{
				...
				if (system != null)
				{
					valid = system.GetControllerStateWithPose(SteamVR.settings.trackingSpace, index, ref state, (uint)System.Runtime.InteropServices.Marshal.SizeOf(typeof(VRControllerState_t)), ref pose);
					UpdateHairTrigger();
				}
			}
		}
