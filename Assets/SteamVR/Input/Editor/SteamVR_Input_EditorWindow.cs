...
public class SteamVR_Input_EditorWindow : EditorWindow
{
    ...
    private bool CopyOrClose()
    {
        ...
        if (copy)
        {
            CopySteamVRInputFiles.CopyFiles(true);
    ...
    private void DrawSets()
    {
        ...
        for (int actionSetIndex = 0; actionSetIndex < SteamVR_Input.actionFile.action_sets.Count; actionSetIndex++)
        {
            ...
            {
                EditorGUILayout.BeginVertical();
                string newName = GUILayout.TextField(SteamVR_Input.actionFile.action_sets[actionSetIndex].name);
                if (newName != SteamVR_Input.actionFile.action_sets[actionSetIndex].name)
                {
                    SteamVR_Input.actionFile.action_sets[actionSetIndex].name = newName;
                }
            ...
            {
                bool pressedSet = GUILayout.Button(SteamVR_Input.actionFile.action_sets[actionSetIndex].name);
    ...
    private void SaveFile()
    {
        ...
        Debug.Log("Saved actions manifest successfully.");
