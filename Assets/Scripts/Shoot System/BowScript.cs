...
public class Bow : MonoBehaviour {
    ...
    private void HandAttachedUpdate(Hand hand)
    {
        ...
        if (nocked)
        {
            Vector3 nockToarrowHand = (arrowManager.arrowNockTransform.parent.position - nockRestTransform.position); // Vector from bow nock transform to arrowhand nock transform - used to align bow when drawing
            ...
            Vector3 arrowNockTransformToHeadset = ((Player.instance.hmdTransform.position + (Vector3.down * 0.05f)) - arrowManager.arrowNockTransform.parent.position).normalized;
            Vector3 arrowHandPosition = (arrowManager.arrowNockTransform.parent.position + ((arrowNockTransformToHeadset * drawOffset) * pullLerp)); // Use this line to lerp arrowHand nock position
    ...
    //-------------------------------------------------
    public void StartNock(ArrowManager manager)
    {
