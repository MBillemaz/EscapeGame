...
//    protected Highlighter objectHighlighter;
...
//    {
//        Interactable ioCheck = objectToSnap.GetComponentInParent<Interactable>();
//        if (ioCheck != null)
//        {
//            ioCheck.
...
//    {
//        if (Application.isPlaying && defaultSnappedObject != null)
//        {
...
//    protected virtual Interactable ValidSnapObject(GameObject checkObject, bool grabState, bool checkGrabState = true)
//    {
//        var ioCheck = checkObject.GetComponentInParent<Interactable>();
...
//    {
//        Highlighter existingHighlighter = Highlighter.GetActiveHighlighter(gameObject);
